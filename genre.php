...
$r = $conn->query("SELECT * FROM genre WHERE slug = '$slug'");
...
$url = 'http://localhost/web/genre/'.$slug;
...
$statement = "media WHERE genre LIKE '%$genre%'";
...
<html>
<head>
<title><?=$genre_name?> Genre List</title>
