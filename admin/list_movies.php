...
$sql = "SELECT * FROM media WHERE tv=0";
...
<div class="content list">
    <div class="top-bar">
        <a href="discover.php">Add New Movie</a>
            ...
            <?php if($res->num_rows > 0) {
                while($row = $res->fetch_array(MYSQLI_ASSOC)) {
                    ...
                    <tr data-id="<?=$tmdbID;?>">
                        ...
                        <td><?=$added;?></td>
                        <td><?=$views;?></td>
                        <td><a href="edit_movie.php?tmdbID=<?=$tmdbID;?>">Edit</a></td>
...
<script>
    ...
    $(document).ready(function(){
        $('.remove').on('click', function() {
            ...
            if(r == true) {
                $.post('edit_movie.php', {tmdbID: id, action: 'delete'}, function(data){
